...
static void analyze_template(const std::string & template_path) {
    ...
    try {
        ...
        // Test 2: With and without add_generation_prompt (single user message)
        {
            ...
            common_chat_render_inputs params_no_prompt;
            ...
            common_chat_render_inputs params_with_prompt = params_no_prompt;
        ...
        // Test 3: Assistant with reasoning_content (user, assistant)
        {
            ...
            common_chat_render_inputs params_no_reasoning;
            ...
            common_chat_render_inputs params_with_reasoning = params_no_reasoning;
        ...
        // Test 5: Tool call in last assistant message (user, assistant)
        {
            ...
            common_chat_render_inputs params_no_tool;
            ...
            common_chat_render_inputs params_with_tool = params_no_tool;
        ...
        // Test 7: One vs two tool calls (user, assistant)
        {
            ...
            common_chat_render_inputs params_one_tool;
            ...
            common_chat_render_inputs params_two_tools = params_one_tool;
