...
static bool detect(const std::string & src) {
    return src.find("<|START_TEXT|>") != std::string::npos &&
        src.find("<|START_ACTION|>") != std::string::npos;
}

const common_chat_parser_def common_chat_parser_cohere2moe = { "cohere2-moe", detect, common_chat_params_init_cohere2moe };
