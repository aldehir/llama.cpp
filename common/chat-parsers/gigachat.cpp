...
static bool detect(const std::string & src) {
    return src.find("<|role_sep|>") != std::string::npos &&
           src.find("<|message_sep|>") != std::string::npos &&
           src.find("<|function_call|>") == std::string::npos;
}

const common_chat_parser_def common_chat_parser_gigachat_v3 = { "gigachat-v3", detect, common_chat_params_init_gigachat_v3 };
