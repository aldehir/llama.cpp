...
static bool detect(const std::string & src) {
    return src.find("<|tool_calls_section_begin|>") != std::string::npos &&
           src.find("<|tool_call_begin|>") != std::string::npos;
}

const common_chat_parser_def common_chat_parser_kimi_k2 = { "kimi-k2", detect, common_chat_params_init_kimi_k2 };
