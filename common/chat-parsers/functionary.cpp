...
static bool detect(const std::string & src) {
    return src.find(">>>all") != std::string::npos && src.find(">>>${recipient}") != std::string::npos;
}

const common_chat_parser_def common_chat_parser_functionary_v3_2 = { "functionary-v3.2", detect, common_chat_params_init_functionary_v3_2 };
